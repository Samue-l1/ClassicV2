...
│𝗗𝗮𝘁𝗲 : ${xdate}
└┬───────────────── ⳹
   │࿈  𝙋𝙡𝙚𝙖𝙨𝙚 𝙏𝙮𝙥𝙚 𝙏𝙝𝙚 *MENU*
   │࿈  𝙂𝙞𝙫𝙚𝙣 *BELOW*
┌└─────────────┈ ⳹
│࿇࿉.${xprefix}𝒂𝒍𝒍𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒅𝒐𝒘𝒏𝒍𝒐𝒂𝒅𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒇𝒖𝒏𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒂𝒊𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒈𝒓𝒐𝒖𝒑𝒎𝒆𝒏𝒖
│࿇࿉${xprefix}𝒐𝒘𝒏𝒆𝒓𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒑𝒉𝒐𝒕𝒐𝒐𝒙𝒚𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒆𝒑𝒉𝒐𝒕𝒐360𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒎𝒂𝒌𝒆𝒓𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒂𝒏𝒊𝒎𝒆𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒏𝒔𝒇𝒘𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒓𝒂𝒏𝒅𝒐𝒎𝒑𝒉𝒐𝒕𝒐𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒓𝒂𝒏𝒅𝒐𝒎𝒗𝒊𝒅𝒆𝒐𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒔𝒕𝒊𝒄𝒌𝒆𝒓𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒅𝒂𝒕𝒂𝒃𝒂𝒔𝒆𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒔𝒕𝒂𝒍𝒌𝒆𝒓𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒃𝒖𝒈𝒎𝒆𝒏𝒖
│࿇࿉.${xprefix}𝒐𝒕𝒉𝒆𝒓𝒎𝒆𝒏𝒖
└─────────────────┈ ⳹`
